...
var server = "wss://pvhetnest.pvhet.com:8989/";
server = "wss://developer.autelrobotics.cn:8989/";
...
const roomdata = {
  ...
  // room:1234
  // room: 1057820190,
  // pin: "6018027629920256",
  room: 1766105703,
  pin: "5552270300708864",
};

$("#serverUrl").val("wss://developer.autelrobotics.cn:8989/");
$("#roomNumber").val(roomdata.room);
$("#pinNumber").val(roomdata.pin);
        ...
        onmessage: function(msg, jsep) {
          ...
          if (event) {
            if (event === "joined") {
              ...
              let r = window.confirm("The room has been destroyed");
              if (r) {
              ...
              if (msg["streams"]) {
                ...
                for (var i in streams) {
                  var stream = streams[i];
                  stream["id"] = myid;
                  stream["display"] = roomdata.username;
                }
...
$(document).ready(function() {
  $("#initBtn").on("click", function() {
    ...
    roomdata.room = +$("#roomNumber").val();
    roomdata.pin = $("#pinNumber").val();

    $("#initBtn").addClass("hide");
      ...
      if (jsep) {
        ...
        remoteFeed.createAnswer({
          ...
          success: function(jsep) {
            ...
            var body = { request: "start", room: roomdata.room };
      ...
      if (track.kind === "audio") {
        ...
        if (!bitrateTimer[remoteFeed.rfindex]) {
          ...
          bitrateTimer[remoteFeed.rfindex] = setInterval(function() {
            ...
            var width = $("#videoremote" + remoteFeed.rfindex + " video").get(0)
              .videoWidth;
